...
\begin{enumerate}
  ...
  \item \textbf{Pregunta} por los cambios que tocan datos y no estructura ---
        ...
        había dejado escrita en la descripción del producto, o darle su tipo a
        los productos de categoría genérica (``FILTRO'', ``ACEITES'') cuando el
        nombre lo dice--- y muestra la lista antes de escribir.
